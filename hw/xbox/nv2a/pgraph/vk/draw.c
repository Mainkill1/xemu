                                   ...
                                   uint32_t relevant_component_mask)
{
    ...
    bool component_only_change = r->blend_constants.command_valid &&
        r->blend_constants.command_guest_color != guest_color &&
        (((r->blend_constants.command_guest_color ^ guest_color) &
    ...
    if (!pgraph_vk_blend_constants_cache_update(
        ...
        if (component_only_change) {
            nv2a_profile_inc_counter(NV2A_PROF_BLEND_COMPONENT_ONLY_SKIPS);
        }
    ...
    if (pgraph_vk_blend_constants_cache_needs_pack(&r->blend_constants,
        ...
        nv2a_profile_inc_counter(NV2A_PROF_BLEND_PACK_REUSES);
    }
...
static void begin_draw(PGRAPHState *pg)
{
    ...
    if (must_bind_pipeline) {
        ...
        if (dynamic_blend_constants) {
            ...
            if (r->blend_constants.command_valid) {
