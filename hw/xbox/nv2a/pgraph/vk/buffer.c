                                      ...
                                      VkDeviceSize required_size)
{
    ...
    return resize_buffer(pg, index, new_size);
}
...
void pgraph_vk_init_buffers(NV2AState *d)
{
    ...
    /* Zeta-to-texture copies reuse this buffer as a transfer source when
     * depth/stencil compute conversion is unnecessary. */
