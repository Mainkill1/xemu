...
typedef enum PerfCpuRegion {
    ...
    VK_PERF_CPU_TEXTURE_STATE_CHECK,
    VK_PERF_CPU_TEXTURE_MEMORY_CHECK,
    VK_PERF_CPU_TEXTURE_IDENTITY_BEFORE,
    VK_PERF_CPU_TEXTURE_PREPARE,
    VK_PERF_CPU_TEXTURE_IDENTITY_AFTER,
    VK_PERF_CPU_TEXTURE_TIMESTAMPS,
    VK_PERF_CPU_TEXTURE_REBIND_DIRTY,
    VK_PERF_CPU_TEXTURE_REBIND_DUMMY,
    VK_PERF_CPU_TEXTURE_CREATE_KEY,
    VK_PERF_CPU_TEXTURE_CREATE_SURFACE,
    VK_PERF_CPU_TEXTURE_CREATE_LOOKUP,
    VK_PERF_CPU_TEXTURE_CREATE_HASH,
    VK_PERF_CPU_TEXTURE_CREATE_CACHE_HIT,
    VK_PERF_CPU_TEXTURE_CREATE_CACHE_MISS,
    VK_PERF_CPU_TEXTURE_PREPARE_DIRTY_STAGE,
    VK_PERF_CPU_TEXTURE_PREPARE_CLEAN_STAGE,
    VK_PERF_CPU_TEXTURE_CREATE_EXACT_SURFACE,
    VK_PERF_CPU_TEXTURE_CREATE_NO_EXACT_SURFACE,
