...
typedef struct PGRAPHVkPerfTelemetry {
    ...
    uint64_t surface_upload_calls;
    uint64_t surface_upload_color_calls;
    uint64_t surface_upload_depth_calls;
    uint64_t surface_upload_force_calls;
    uint64_t surface_upload_bytes;
...
typedef struct PGRAPHVkState {
    ...
    bool texture_shader_inputs_pending;
