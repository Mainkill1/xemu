...
static const char *cpu_region_names[VK_PERF_CPU_REGION_COUNT] = {
    ...
    [VK_PERF_CPU_TEXTURE_PREPARE_DIRTY_STAGE] = "texture_prepare_dirty_stage",
    [VK_PERF_CPU_TEXTURE_PREPARE_CLEAN_STAGE] = "texture_prepare_clean_stage",
    [VK_PERF_CPU_TEXTURE_CREATE_EXACT_SURFACE] = "texture_create_exact_surface",
    [VK_PERF_CPU_TEXTURE_CREATE_NO_EXACT_SURFACE] = "texture_create_no_exact_surface",
};
