...
#define NV2A_PROF_COUNTERS_XMAC \
    ...
    _X(NV2A_PROF_SHADER_MODULE_MISS) \
    _X(NV2A_PROF_SHADER_SOURCE_FIRST) \
    _X(NV2A_PROF_SHADER_SOURCE_REPEAT) \
    _X(NV2A_PROF_SHADER_SOURCE_SATURATED) \
    _X(NV2A_PROF_SHADER_COMPILER_INVOCATION) \
